  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h1 className="text-xl font-extrabold tracking-tight text-foreground">Новий проєкт</h1>
      </div>
      <Link href="/admin/projects" className="text-xs text-muted-foreground hover:text-indigo-600 dark:hover:text-indigo-400 font-medium transition-colors mb-6 inline-block">
        ← Назад до проєктів
      </Link>
      ...
      <div className={cn(
        ...
        <div className="space-y-5">
          ...
          <div>
            <label className="block text-[11px] font-bold uppercase tracking-widest text-muted-foreground mb-1.5">
              ОПИС <span className="text-muted-foreground/50 normal-case font-normal">(необов'язково)</span>
            </label>
            <textarea
              value={description}
          ...
          <div className="flex items-center gap-3 pt-1">
            ...
            >
              ...
              {saving ? "Створення..." : "Створити та продовжити"}
            </button>
            <Link
              href="/admin/projects"
              className={cn(
      ...
      <p className="mt-4 text-xs text-muted-foreground">
        Після створення ви зможете додати учасників та файли до проєкту.
      </p>
    </div>
  );
}
