      ...
      <div className="relative mx-auto flex max-w-5xl items-center justify-between px-4 h-14">
        ...
        <nav className="flex items-center gap-2" aria-label="Main navigation">
          ...
          <Link
            href="/items/new"
            className={cn(
              "relative inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold overflow-hidden",
              "w-[152px] shrink-0",
          ...
          >
            {/* Lighter gradient overlay — fades in on hover */}
