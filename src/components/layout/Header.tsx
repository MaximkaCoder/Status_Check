          ...
          {user?.isAdmin && (
            <Link
              ...
              className={cn(
                ...
                "hover:bg-white/60 dark:hover:bg-white/[0.10] hover:text-violet-500 dark:hover:text-violet-400",
                "shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] dark:shadow-none",
                "transition-all duration-150",
                pathname.startsWith("/reports") && "text-violet-500 dark:text-violet-400"
              )}
          ...
          {user?.isAdmin && (
            <Link
              ...
              className={cn(
                ...
                "shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] dark:shadow-none",
                "transition-all duration-150",
                pathname.startsWith("/admin") && "text-indigo-500 dark:text-indigo-400"
              )}
              aria-label="Admin panel"
            >
              <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
              </svg>
            </Link>
          )}
            ...
            <div className="flex items-center gap-1.5">
              <Link
                ...
                className={cn(
                  ...
                  "shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] dark:shadow-none",
                  "hover:bg-white/60 dark:hover:bg-white/[0.10] transition-colors duration-150",
                  pathname.startsWith("/settings") && "border-indigo-400/50 text-indigo-600 dark:text-indigo-300"
                )}
              >
                ...
                <svg className="h-3.5 w-3.5 flex-shrink-0 text-slate-400 dark:text-white/40" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
